...
while True:
   ...
   if command == "cat LOCKED-1":
       ...
       if LOCKED1pass == "46273":
           print("Well, you must have gotten my last message. This is LOG-2, I'm starting to forget the outside. I can't remember the last time I saw someone... The LOCKED-2 key is in the file hidden.txt. You won't see it with the list command, but it's there.")
   ...
   if command == "convert LOG-1":
       print("What happened? How did this happen?")
       print("LOCKED-1 KEY = 46273.")
   ...
   if command == "data.cat.IP{410.904.9.5} CLASSIFIED.txt":
       ...
       ServerSafe = 0
       print("Message.txt has been updated: Use the command data.escape.IP{410.904.9.5}!")
